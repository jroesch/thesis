...
% TODO(talk about how we provide building blocks to build new quantization framework)
%
% Instead, Relay includes a generic, compiler-based quantization flow that supports a diverse set
...
%   from \verb|fp32| to a type such as \verb|int4|.
  ...
  \section{Quantized Inference on ARM Platforms}
...
\section{Dynamic Memory Allocation and Device Placement}
