...
During the Big Data era, these hand engineered algorithms were displaced by
  simpler algorithms applied to the abundantly available data\citep{unreasonable}
...
Instead of building a single IR and compiler to rule them all\footenote{and in the darkness bind them}
