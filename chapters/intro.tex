...
A particular way in which deep learning frameworks have been narrowly focused
  ...
  Specifically, these models represented as static data flow graphs where the
  sizes of each input and output (i.e. tensors or $n$-dimensional arrays) are known a priori,
...
Frameworks have enough general mechanisms that writing dynamic = models was mostly possibly
