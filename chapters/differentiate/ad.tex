...
An important property of machine learning computations is
  differentiability.
Optimization algorithms like stochastic gradient descent require
  computing gradients of functions (Section~\ref{sec:background}).
