...
\title{A high-level compiler for high-performance machine learning systems.} % Title of the book
...
\input{chapters/ad}
\input{chapters/dynamic_nn}
\input{chapters/nimble}
\input{chapters/frameworks}
\input{chapters/opt_for_non_experts}
\input{chapters/accel_support}
